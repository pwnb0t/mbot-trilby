...
namespace SidekickApi.Model
{
    ...
    /// StopClipRequest
    /// </summary>
    public partial class StopClipRequest : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="StopClipRequest" />
    /// </summary>
    public class StopClipRequestJsonConverter : JsonConverter<StopClipRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="StopClipRequest" />
        /// </summary>
        ...
        public override StopClipRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="StopClipRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="stopClipRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, StopClipRequest stopClipRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, stopClipRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="StopClipRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="stopClipRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, StopClipRequest stopClipRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (stopClipRequest.RequestIdOption.IsSet)
                if (stopClipRequest.RequestIdOption.Value != null)
                    writer.WriteString("request_id", stopClipRequest.RequestId);
                else
