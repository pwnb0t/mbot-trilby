...
{
    /// <summary>
    /// PlayRandomClipRequest
    /// </summary>
    public partial class PlayRandomClipRequest : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="PlayRandomClipRequest" />
    /// </summary>
    public class PlayRandomClipRequestJsonConverter : JsonConverter<PlayRandomClipRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="PlayRandomClipRequest" />
        /// </summary>
        ...
        public override PlayRandomClipRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="PlayRandomClipRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="playRandomClipRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PlayRandomClipRequest playRandomClipRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, playRandomClipRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PlayRandomClipRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="playRandomClipRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PlayRandomClipRequest playRandomClipRequest, JsonSerializerOptions jsonSerializerOptions)
        {
