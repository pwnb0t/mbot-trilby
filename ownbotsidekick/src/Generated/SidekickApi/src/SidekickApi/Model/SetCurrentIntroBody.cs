...
namespace SidekickApi.Model
{
    ...
    /// SetCurrentIntroBody
    /// </summary>
    public partial class SetCurrentIntroBody : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="SetCurrentIntroBody" />
    /// </summary>
    public class SetCurrentIntroBodyJsonConverter : JsonConverter<SetCurrentIntroBody>
    {
        /// <summary>
        /// Deserializes json to <see cref="SetCurrentIntroBody" />
        /// </summary>
        ...
        public override SetCurrentIntroBody Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="SetCurrentIntroBody" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="setCurrentIntroBody"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SetCurrentIntroBody setCurrentIntroBody, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, setCurrentIntroBody, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SetCurrentIntroBody" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="setCurrentIntroBody"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SetCurrentIntroBody setCurrentIntroBody, JsonSerializerOptions jsonSerializerOptions)
        {
