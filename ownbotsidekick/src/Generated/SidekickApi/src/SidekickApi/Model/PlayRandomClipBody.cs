...
namespace SidekickApi.Model
{
    ...
    public partial class PlayRandomClipBody : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PlayRandomClipBody(long requesterUserId, Option<string?> requestId = default)
        {
    ...
    public class PlayRandomClipBodyJsonConverter : JsonConverter<PlayRandomClipBody>
    {
        ...
        public override PlayRandomClipBody Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!requesterUserId.IsSet)
                throw new ArgumentException("Property is required for class PlayRandomClipBody.", nameof(requesterUserId));

            if (requesterUserId.IsSet && requesterUserId.Value == null)
                throw new ArgumentNullException(nameof(requesterUserId), "Property is not nullable for class PlayRandomClipBody.");

            return new PlayRandomClipBody(requesterUserId.Value!.Value!, requestId);
        }
        ...
        {
            writer.WriteNumber("requester_user_id", playRandomClipBody.RequesterUserId);
