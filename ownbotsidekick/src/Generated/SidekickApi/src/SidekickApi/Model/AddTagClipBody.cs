...
namespace SidekickApi.Model
{
    ...
    public partial class AddTagClipBody : IValidatableObject
    {
        ...
        [JsonConstructor]
        public AddTagClipBody(long guildId, string clipTrigger)
        {
            GuildId = guildId;
    ...
    public class AddTagClipBodyJsonConverter : JsonConverter<AddTagClipBody>
    {
        ...
        public override AddTagClipBody Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!guildId.IsSet)
                throw new ArgumentException("Property is required for class AddTagClipBody.", nameof(guildId));
            ...
            if (guildId.IsSet && guildId.Value == null)
                throw new ArgumentNullException(nameof(guildId), "Property is not nullable for class AddTagClipBody.");
            ...
            return new AddTagClipBody(guildId.Value!.Value!, clipTrigger.Value!);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, AddTagClipBody addTagClipBody, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            writer.WriteNumber("guild_id", addTagClipBody.GuildId);
