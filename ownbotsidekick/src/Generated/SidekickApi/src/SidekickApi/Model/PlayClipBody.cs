...
namespace SidekickApi.Model
{
    ...
    /// PlayClipBody
    /// </summary>
    public partial class PlayClipBody : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="PlayClipBody" />
    /// </summary>
    public class PlayClipBodyJsonConverter : JsonConverter<PlayClipBody>
    {
        /// <summary>
        /// Deserializes json to <see cref="PlayClipBody" />
        /// </summary>
        ...
        public override PlayClipBody Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="PlayClipBody" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="playClipBody"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PlayClipBody playClipBody, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, playClipBody, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PlayClipBody" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="playClipBody"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PlayClipBody playClipBody, JsonSerializerOptions jsonSerializerOptions)
        {
