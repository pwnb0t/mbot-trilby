...
{
    /// <summary>
    /// Provides hosting configuration for TrilbyApi
    /// </summary>
    public class HostConfiguration
    {
        ...
        public HostConfiguration(IServiceCollection services)
        {
            ...
            _jsonOptions.Converters.Add(new AuthenticatedTrilbyGuildResponseJsonConverter());
            ...
            _jsonOptions.Converters.Add(new PlayClipBodyJsonConverter());
            _jsonOptions.Converters.Add(new PlayClipResponseJsonConverter());
            _jsonOptions.Converters.Add(new PlayRandomClipBodyJsonConverter());
            ...
            Action<HttpClient>? client = null, Action<IHttpClientBuilder>? builder = null)
        {
            ...
            builders.Add(_services.AddHttpClient<IDefaultApi, DefaultApi>("TrilbyApi.Api.IDefaultApi", client));
